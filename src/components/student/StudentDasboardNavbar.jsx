...
const StudentNavbar = ({ toggleSidebar, isSidebarOpen, isDark, toggleTheme }) => {
  return (
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative w-64 hidden md:block">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2 rounded-lg border transition-all duration-200 ${
                  isDark 
                    ? 'bg-gray-700 border-gray-600 text-gray-200 placeholder-gray-400 focus:ring-indigo-500 focus:border-indigo-500' 
                    : 'bg-gray-50 border-gray-300 text-gray-900 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500'
            ...
            <div className="flex items-center space-x-3 cursor-pointer">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center font-semibold text-white bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg`}>
                JS
              </div>
